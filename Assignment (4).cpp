...
/* Ambient vars */
float amb[] = { 1.0f, 1.0f, 1.0f };			/* Ambient light - White */
float posA[] = { -10.0f, 10.0f, 10.0f };		/* Light position above sphere (Y = 0.8) */
float ambM[] = { 1.0f, 0.0f, 0.0f };		/* Ambient material - Blue */

/* Diffuse vars */
float dif[] = { 1.0f, 1.0f, 1.0f };			/* Diffuse light - White */
float posD[] = { -10.0f, 10.0f, 10.0f };		/* Light position right of sphere (X = 0.8) */
float difM[] = { 1.0f, 0.0f, 0.0f };		/* Diffuse material - Blue */
...
void ArmCombine() {
	GLuint texture[5];
	if (isTextureOn) {
		texture[0] = loadTexture("whiteMetal.bmp");
		robotShoulder();
		texture[1] = loadTexture("whiteMetal.bmp");
		robotUpperArm();
		texture[2] = loadTexture("whiteMetal.bmp");
		robotBottomArm();
		texture[3] = loadTexture("MetalBlack.bmp");
		robotHand();
		texture[4] = loadTexture("MetalBlack.bmp");
		robotArmJoint();
		...
		texture[0] = loadTexture("white.bmp");
		robotShoulder();
		texture[1] = loadTexture("white.bmp");
		robotUpperArm();
		texture[2] = loadTexture("white.bmp");
		robotBottomArm();
		texture[3] = loadTexture("black.bmp");
		robotHand();
		texture[4] = loadTexture("black.bmp");
		robotArmJoint();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
		glDeleteTextures(1, &texture[2]);
...
void robotDrawBody() {
	...
	if (isTextureOn) {
		texture[0] = loadTexture("blueMetal.bmp");
		robotChest();
		texture[1] = loadTexture("redMetal.bmp");
		robotWaist();
		texture[2] = loadTexture("whiteMetal.bmp");
		robotPelvic();
		texture[3] = loadTexture("yellowMetal.bmp");
		robotSkirtcube();
		glPopMatrix();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
		...
		texture[0] = loadTexture("blue.bmp");
		robotChest();
		texture[1] = loadTexture("red.bmp");
		robotWaist();
		texture[2] = loadTexture("white.bmp");
		robotPelvic();
		texture[3] = loadTexture("yellow.bmp");
		robotSkirtcube();
		glPopMatrix();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
...
void robotEyes() {
	glBegin(GL_QUADS);
	glVertex3f(1.75626, 0.970922, 1);
	glVertex3f(3.75559, 1.08376, 1);
	glVertex3f(2.79901, -0.993144, 1.00442);
	glVertex3f(2.79901, -0.993144, 1.00442);

	glVertex3f(-1, 1, 1);
	glVertex3f(1, 1, 1);
	glVertex3f(0.01929, -1.02224, 1.00442);
	glVertex3f(0.01929, -1.02224, 1.00442);
	glEnd();
}

void robotmiddleHorn() {
	//middle cube
...
void robotDrawHead() {
	GLuint texture[5];
	glPushMatrix();
	glTranslatef(-0.771389, 12.7687, -0.715586);
	glRotatef(-0.453246, 0, 0, 1);
	glScalef(0.380796, 0.173937, 1.0);
	texture[4] = loadTexture("blueMetal.bmp");
	robotEyes();
	glPopMatrix();
	glDeleteTextures(1, &texture[4]);
	...
	if (isTextureOn) {
		texture[0] = loadTexture("redMetal.bmp");
		robotmiddleHorn();
		texture[1] = loadTexture("yellowMetal.bmp");
		robotsideHorn();
		texture[2] = loadTexture("whiteMetal.bmp");
		robotMouth();
		texture[3] = loadTexture("whiteMetal.bmp");
		robotHead();
		glPopMatrix();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
		...
		texture[0] = loadTexture("red.bmp");
		robotmiddleHorn();
		texture[1] = loadTexture("yellow.bmp");
		robotsideHorn();
		texture[2] = loadTexture("white.bmp");
		robotMouth();
		texture[3] = loadTexture("white.bmp");
		robotHead();
		glPopMatrix();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
...
void robotSwordhandle() {
	AssignCoo(p1, 0.594154, -1.08351, -1.22703);
	AssignCoo(p2, -1.79263, -1.08351, -1.22703);
	AssignCoo(p3, -1.79263, -1.4899, -1.22703);
	AssignCoo(p4, 0.594154, -1.4899, -1.22703);
	AssignCoo(p5, 0.594153, -1.08351, 1.07465);
	AssignCoo(p6, -1.79263, -1.08351, 1.07465);
	AssignCoo(p7, -1.79263, -1.4899, 1.07465);
	AssignCoo(p8, 0.594153, -1.4899, 1.07465);
...
void robotDrawSword() {
	...
	if (isTextureOn) {
		texture[0] = loadTexture("whiteMetal.bmp");
		robotSwordhandle();
		texture[1] = loadTexture("cyan.bmp");
		robotSwordBlade();
		glPopMatrix();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
		...
		texture[0] = loadTexture("black.bmp");
		robotSwordhandle();
		texture[1] = loadTexture("green.bmp");
		robotSwordBlade();
		glPopMatrix();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
...
void robotDrawShield() {
	...
	if (isTextureOn) {
		texture[0] = loadTexture("yellowMetal.bmp");
		robotSheildStar();
		texture[1] = loadTexture("redMetal.bmp");
		robotSheildInner();
		texture[2] = loadTexture("whiteMetal.bmp");
		...
		texture[0] = loadTexture("yellow.bmp");
		robotSheildStar();
		texture[1] = loadTexture("red.bmp");
		robotSheildInner();
		texture[2] = loadTexture("white.bmp");
...
void robotDrawLeftLeg() {
	...
	if (isTextureOn) {
		...
		texture[1] = loadTexture("whiteMetal.bmp");
		robotCalf();
		texture[2] = loadTexture("blueMetal.bmp");
		robotKnee();
		texture[3] = loadTexture("redMetal.bmp");
		robotLeg();
		texture[4] = loadTexture("whiteMetal.bmp");
		robotLeg2();
		glPopMatrix();
		texture[5] = loadTexture("MetalBlack.bmp");
		robotLeftLegJoint();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
		glDeleteTextures(1, &texture[2]);
		...
		texture[1] = loadTexture("white.bmp");
		robotCalf();
		texture[2] = loadTexture("blue.bmp");
		robotKnee();
		texture[3] = loadTexture("red.bmp");
		robotLeg();
		texture[4] = loadTexture("white.bmp");
		robotLeg2();
		glPopMatrix();
		texture[5] = loadTexture("black.bmp");
		robotLeftLegJoint();
		glDeleteTextures(1, &texture[0]);
		glDeleteTextures(1, &texture[1]);
		glDeleteTextures(1, &texture[2]);
